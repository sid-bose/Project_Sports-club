  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
      <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
        ...
        <h2 class="text-xl font-medium title-font text-white mt-5">Create Events</h2>
        <p class="text-base leading-relaxed mt-2">Create Events for the memebers</p>
        <a href="type_selector.php" class="text-indigo-400 inline-flex items-center mt-3">Learn More
        ...
        <h2 class="text-xl font-medium title-font text-white mt-5">Created Events</h2>
        <p class="text-base leading-relaxed mt-2"></p>
        <a href="created_events_c.php" class="text-indigo-400 inline-flex items-center mt-3">Learn More
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
        </a>
